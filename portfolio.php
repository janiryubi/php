...
<html lang="ko">
    <head>
        ...
        <meta name="description" content="한국 최고 개발자 유예빈" />
        <meta name="author" content="유예빈" />
        <title>유예빈 - 프론트엔드 종결자</title>
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="assets/favicon.ico" /><!--로고 만들기-->
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Ryubi</a>
